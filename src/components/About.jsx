            ...
            <Fade triggerOnce>
              <div className="flex flex-col">
                ...
                <p className="mb-8">
                  ...
                  <br />
                  <br />
                  Cuento con cualidades de trabajo en equipo y de comunicación efectiva, apoyandome
                  en el uso de metodologias agiles, lo cual me convierte en un profesional
                  organizado y eficaz.
                </p>
              </div>
              </Fade >
