...
const Portfolio = () => {
  return (
    <section id="portfolio" className="pb-2 section bg-primary">
      <div className="container mx-auto">
        <div className="flex flex-col items-center text-center">
          <h2 className="section-title before:content-portfolio relative before:absolute before:opacity-40 before:-top-[2rem] before:-left-1/2  before:-right-1/2  before:hidden before:lg:block">
